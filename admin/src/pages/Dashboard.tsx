...
import { FIND_ALL_NEWS, REMOVE_NEWS } from '../graphql/queries';
import { NewsStatus, type News, type NewsFilterInput } from '../types';
  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#f5f5f5' }}>
      ...
      <Dialog open={!!deleteConfirm} onClose={() => setDeleteConfirm(null)}>
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to permanently remove this news? This action cannot be undone.
          </Typography>
        </DialogContent>
        <DialogActions>
